...
ScavTrap::ScavTrap()
{
	...
	this->EP = 50;
	this->AD = 20;
	std::cout << Green << "ScavTrap (Child) Default constructor called" << Reset << std::endl;
}
...
ScavTrap::ScavTrap(std::string name)
{
	...
	this->EP = 50;
	this->AD = 20;
	std::cout << Green << "ScavTrap (Child) constructor called with string"<< Reset << std::endl;
}

ScavTrap::ScavTrap(const ScavTrap &ref)
{
	*this = ref;
	std::cout << Green << "ScavTrap (Chile) Copy constructor called" << Reset << std::endl;
}
